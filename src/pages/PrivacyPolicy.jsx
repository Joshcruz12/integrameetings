...
const PrivacyPolicy = () => {
  return (
    <div className="pt-[250px] flex items-center justify-center w-full">
      <div className="w-[60%]">
        <h1 className="title title-medium text-center">Privacy Policy&nbsp;</h1>

        <p className="text-justify font-light text-[17px] mt-5">
          Updated at 2022-10-14&nbsp;
        </p>

        <p className="text-justify font-light text-[17px]">
          Integra Meetings (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          <a href="https://integrameetings.com/index-english.html">
            https://integrameetings.com/index-english.html
          </a>
        ...
        <h5 className="subtitle font-bold text-left pt-[2%] pb-[2%] text-xl">
        ...
        <ul className="text-justify font-light text-[17px]">
          <li>
          ...
          <li>
            ...
            to Integra Meetings S.A. de C.V., Rodr&iacute;guez Saro 100, Int.
            502, Colonia Actipan, Benito Ju&aacute;rez, Ciudad de M&eacute;xico,
            03230 that is responsible for your information under this Privacy
            Policy.
          </li>

          <li>
            Country: where Integra Meetings or the owners/founders of Integra
            Meetings are based, in this case is United States of America.&nbsp;
          </li>

          <li>
            Customer: refers to the company, organization or person that signs
            up to use the Integra Meetings Service to manage the relationships
            with your consumers or service users.&nbsp;
          </li>

          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Integra
            Meetings and use the services.&nbsp;
          </li>
          ...
          <li>
            Personnel: refers to those individuals who are employed by Integra
            Meetings or are under contract to perform a service on behalf of one
            of the parties.&nbsp;
          </li>
          ...
          <li>
            Service: refers to the service provided by Integra Meetings as
          ...
          <li>
            Website: Integra Meetings&rsquo;s site, which can be accessed via
            this URL:{" "}
            <a href="https://integrameetings.com/index-english.html">
              https://integrameetings.com/index-english.html
            </a>
          ...
          <li>
            You: a person or entity that is registered with Integra Meetings to
            use the Services
          </li>
        </ul>
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          personal and nonpersonal information to our successors-in-interest
        </p>
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          purchase through our service. We will likely share your personal
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          We are incorporated in United States of America. Information collected
          via our website, through direct interactions with you, or from use of
          our help services may be transferred from time to time to our offices
          or personnel, or to third parties, located throughout the world, and
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          this Privacy Policy. How Long Do We Keep Your Information? We keep
          your information only so long as we need it to provide service to you
          and fulfill the purposes described in this policy. This is also the
          case for anyone that we share your information with and who carries
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          rules, shall govern this Agreement and your use of our service. Your
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          person. Personal data extends beyond a person&rsquo;s name or email
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          the right thing to do. At Help Scout we strongly believe that your
        ...
        <p className="text-justify font-light text-[17px] mt-5">
          ...
          above. We are also required to communicate information about rights
          ...
          Personal Information we collect, use, or share; (2) purposes for which
          ...
          (4) specific pieces of Personal Information we have collected about
          you. Right to Equal Service. We will not discriminate against you if
          you exercise your privacy rights. Right to Delete. You may submit a
          verifiable request to close your account and we will delete Personal
          Information about you that we have collected. Request that a business
          that sells a consumer&apos;s personal data, not sell the
          ...
          rights, please contact us. We do not sell the Personal Information of
          our users. For more information about these rights, please contact us.
        </p>
        ...
        <ul className="text-justify font-light text-[17px]">
          <li>Via Email: info@integrameetings.com&nbsp;</li>
          <li>Via Phone Number: 55 7580 2950&nbsp;</li>
          <li>
            Via this Link: https://integrameetings.com/index-english.html&nbsp;
          </li>
          <li>
            Via this Address: Rodr&iacute;guez Saro 100, Int. 502, Colonia
            Actipan, Benito Ju&aacute;rez, Ciudad de M&eacute;xico, 03230
          </li>
        </ul>
      </div>
    </div>
